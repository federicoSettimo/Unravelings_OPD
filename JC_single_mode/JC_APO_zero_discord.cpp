...
double tmin = 0., tmax = 10., dt = 0.001, g = .5, omega_S = 1., omega_E = .1, n0_phi = (double)n0, n1_phi = (double)n1;
bool printTraj = true;

// Functions of the ME
// Map \Phi^0
double R_p (double t) {return g*g*(n0_phi+1.)*sin((omega_S-omega_E)*t)/(omega_S-omega_E);}
double R_m (double t) {return g*g*n0_phi*sin((omega_S-omega_E)*t)/(omega_S-omega_E);}
double I_p (double t) {return g*g*(n0_phi+1.)*(1.-cos((omega_S-omega_E)*t))/(omega_S-omega_E);}
double I_m (double t) {return g*g*n0_phi*(1.-cos((omega_S-omega_E)*t))/(omega_S-omega_E);}
// Map \Phi^1
/*double R_p (double t) {return g*g*(n1_phi+1.)*sin((omega_S-omega_E)*t)/(omega_S-omega_E);}
double R_m (double t) {return g*g*n1_phi*sin((omega_S-omega_E)*t)/(omega_S-omega_E);}
double I_p (double t) {return g*g*(n1_phi+1.)*(1.-cos((omega_S-omega_E)*t))/(omega_S-omega_E);}
double I_m (double t) {return g*g*n1_phi*(1.-cos((omega_S-omega_E)*t))/(omega_S-omega_E);}*/
...
void unravel (const string &alpha, const string &index) {
  ...
  string out_index = "_Phi_0_Q_"+alpha+"_"+index+"_zero_discord.txt";
