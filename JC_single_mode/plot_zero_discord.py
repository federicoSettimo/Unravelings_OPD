...
ax[1].plot(t, exact_rho_S, color=colors[4], label=r'$\mathcal{R}=\operatorname{id}$', marker=markers[4], markersize=markersize, markevery=len(t))
ax[1].errorbar(t, avg_rho_S, err_rho_S, color=colors[4], marker=markers[4], markevery=markevery, errorevery=markevery, markersize=markersize, linewidth=0, elinewidth=1)
...
ax[1].plot(t, exact_R1, color=colors[0], label=r'$\mathcal{R}=\sigma_x\cdot\sigma_x$', marker=markers[0], markersize=markersize, markevery=len(t))
ax[1].errorbar(t, avg_R1, err_rho_S, color=colors[0], marker=markers[0], markevery=markevery, errorevery=markevery, markersize=markersize, linewidth=0, elinewidth=1)
...
ax[1].plot(t, exact_R2, color=colors[1], label=r'$\mathcal{R}=\langle0\vert\cdot\vert0\rangle\,\vert0\rangle\langle0\vert$', marker=markers[1], markersize=markersize, markevery=len(t))
ax[1].errorbar(t, avg_R2, err_rho_S, color=colors[1], marker=markers[1], markevery=markevery, errorevery=markevery, markersize=markersize, linewidth=0, elinewidth=1)
